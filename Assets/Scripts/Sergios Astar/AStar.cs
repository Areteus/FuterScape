...
public class AStar
{
    ...
    private static ArrayList CalculatePath(SNode node)
    {
    ...
    private static float EstimateHeuristicCost(SNode currentNode, SNode goalNode)
    {
    ...
    public static ArrayList FindPath(SNode start, SNode goal)
    {
        ...
        while (openList.Length != 0)
        {
            ...
            {
                SNode neighborNode = (SNode)neighbors[i];
